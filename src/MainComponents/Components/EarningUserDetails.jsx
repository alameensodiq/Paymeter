...
import { UserDataEarning } from "../Store/Apis/UserDataEarning";

const EarningUserDetails = ({ title }) => {
  ...
  const { userdataearning, authenticatinguserdataearning } = useSelector(
    (state) => state?.userdataearning
  );
  console.log(userdataearning);
  ...
  }, [userdataearning?.data, earningtrans?.data]);
            ...
            <div className="flex lg:flex-row flex-col md:flex-col gap-3">
                ...
                <div className="w-[77%] flex flex-col gap-2 mt-10 pl-5">
                  ...
                  <span className="text-color-user text-[20px] font-bold">
                    {formatNumberWithCommas(
                      userdataearning?.data?.totalTransactionCount
                    )}
                  </span>
                  {/* <div className="flex flex-row gap-1 text-[10px]">
                  <span>
              ...
              >
                <div className="w-[77%] flex flex-col gap-2 mt-10 pl-5">
                  ...
                  <span className="text-color-user text-[20px] font-bold flex flex-wrap">
                    {formatNumberWithCommas(
                      userdataearning?.data?.totalRevenue
                    )}
                  </span>
                  {/* <div className="flex flex-row gap-1 text-[10px]">
                    <span>
...
export default EarningUserDetails;
