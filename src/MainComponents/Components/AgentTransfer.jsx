...
const AgentTransfer = ({ title }) => {
  ...
  useEffect(() => {
    if (agenttransactions?.data?.data) {
      setTimeout(() => {
        setloading(true);
      }, [2000]);
    }
  ...
  const totalPosts = agenttransactions?.data?.meta?.totalCount;
              ...
              <>
                {agenttransactions?.data?.data?.length >= 1 && (
                  <Tables
                    ...
                    agenttransfer
                    // transfers
                    data={agenttransactions?.data?.data}
                    currentPage={currentPage}
                  />
                )}
                {!agenttransactions?.status && (
                  <div
                    style={{
                      display: "flex",
