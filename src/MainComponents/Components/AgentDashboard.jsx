...
import { AgentTransactions } from "../Store/Apis/AgentTransactions";
import { AgentSummary } from "../Store/Apis/AgentSummary";

const AgentDashboard = ({ title }) => {
  ...
  useEffect(() => {
    if (sessionStorage.getItem("token")) {
      ...
      dispatch(
        AgentTransactions({ startDate, searcher, currentPage, endDate })
      );
  ...
  const { agenttransactions, authenticatingagenttransactions } = useSelector(
    (state) => state?.agenttransactions
  );
  ...
  const { agentsummary, authenticatingagentsummary } = useSelector(
    (state) => state?.agentsummary
  );
            ...
            <div className="flex lg:flex-row flex-col md:flex-col gap-3">
              ...
              >
                <div className="w-[77%] flex flex-col gap-2 mt-10 pl-5">
                  ...
                  <span className="text-color-user text-[20px] font-bold">
                    ₦{formatNumberWithCommas(agentsummary?.data?.todayRevenue)}
                  </span>
                  <div className="flex flex-row gap-1 text-[10px]">
                    <span className="text-black text-[12px]">
                      Transaction Count:{" "}
                      {formatNumberWithCommas(
                        agentsummary?.data?.todayTransactionCount
                      )}
                    </span>
              ...
              >
                <div className="w-[77%] flex flex-col gap-2 mt-10 pl-5">
                  ...
                  <span className="text-color-user text-[20px] font-bold">
                    ₦{formatNumberWithCommas(agentsummary?.data?.weeklyRevenue)}
                  </span>
                  <div className="flex flex-row gap-1 text-[10px]">
                    <span className="text-black text-[12px]">
                      Transaction Count:
                      {formatNumberWithCommas(
                        agentsummary?.data?.weeklyTransactionCount
                      )}
                    </span>
              ...
              >
                <div className="w-[77%] flex flex-col gap-2 mt-10 pl-5">
                  ...
                  <span className="text-color-user text-[20px] font-bold flex flex-wrap">
                    {/* ₦1 */}₦{" "}
                    {formatNumberWithCommas(agentsummary?.data?.monthlyRevenue)}
                  ...
                  <div className="flex flex-row gap-1 text-[10px]">
                    <span className="text-black text-[12px]">
                      Transaction Count:{" "}
                      {formatNumberWithCommas(
                        agentsummary?.data?.monthlyTransactionCount
                      )}
                    </span>
                    {/* <span className="text-card-user">6.5%</span>
              ...
              >
                <div className="w-[77%] flex flex-col gap-2 mt-10 pl-5">
                  ...
                  <span className="text-color-user text-[20px] font-bold flex flex-wrap">
                    ₦{formatNumberWithCommas(agentsummary?.data?.yearlyRevenue)}
                  </span>
                  <div className="flex flex-row gap-1 text-[10px]">
                    <span className="text-black text-[12px]">
                      Transaction Count:{" "}
                      {formatNumberWithCommas(
                        agentsummary?.data?.yearlyTransactionCount
                      )}
                    </span>
                    {/* <span className="text-card-user">6.5%</span>
